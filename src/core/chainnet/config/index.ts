...
export const networkDetails = {
  [NETWORK_LIST.Horus]: {
    WEB3_RPC_URL: "https://data-seed-prebsc-1-s1.binance.org:8545/", //process.env.REACT_APP_BSC_TESTNET_WEB3_RPC_URL as string || "", //"https://data-seed-prebsc-1-s1.binance.org:8545/", //"https://polygon-mumbai.g.alchemy.com/v2/46LmJOYydi52yqUdANxbLDReG13MDYw5"; //"https://rpc-mumbai.polygon.technology/v1/84cc5f2f2beca130d1d33b38a7085e5d8b57d404";
    ...
    CENTRALIZED_SERVER_URL: 'http://8.219.11.39:8181', //process.env.REACT_APP_CENTRALIZED_SERVER_URL as string || "", //"http://8.219.11.39:8181", //"http://54.241.67.36:8181",
    ...
    PORTER_URL: 'http://8.219.11.39:9165', //process.env.REACT_APP_BSC_TESTNET_PORTER_URI as string || "", //"http://8.222.146.98:9165", //"http://54.241.67.36:9155", // "http://8.219.188.70:9155", //"https://porter-ibex.nucypher.community"; //nucypher porter service url
    CONTRACT_INFO: contractList[NETWORK_LIST.Horus],
    TOKEN_ADDRESS: "0x0000000000000000000000000000000000000001", //process.env.REACT_APP_BSC_TESTNET_BNB_ADDRESS || "",
    TOKEN_SYMBOL: "TBNB",
    NLK_TOKEN_SYMBOL: "TNLK",
    NLK_TOKEN_ADDRESS: "0x79725FC1badFd5f744c0d293d528197EaA88fdE5", //process.env.REACT_APP_BSC_TESTNET_CONTRACT_NULINKTOKEN_ADDRESS || "",
  },
