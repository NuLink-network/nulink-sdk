...
export const networkDetails = {
  [NETWORK_LIST.Horus]: {
    ...
    CENTRALIZED_SERVER_URL: process.env.REACT_APP_CENTRALIZED_SERVER_URL as string || "", //'http://8.219.11.39:8181', //process.env.REACT_APP_CENTRALIZED_SERVER_URL as string || "",
    ...
    PORTER_URL: process.env.REACT_APP_BSC_TESTNET_PORTER_URI as string || "", //'http://8.219.11.39:9165', //process.env.REACT_APP_BSC_TESTNET_PORTER_URI as string || "", //"http://54.241.67.36:9155",
