...
export const networkDetails = {
  [NETWORK_LIST.Horus]: {
    WEB3_RPC_URL: process.env.REACT_APP_WEB3_RPC_URL as string, //"https://data-seed-prebsc-1-s1.binance.org:8545/", //"https://polygon-mumbai.g.alchemy.com/v2/46LmJOYydi52yqUdANxbLDReG13MDYw5"; //"https://rpc-mumbai.maticvigil.com/v1/84cc5f2f2beca130d1d33b38a7085e5d8b57d404";
    ...
    PORTER_URL: process.env.REACT_APP_PORTER_URL as string, //"https://8.219.11.39:9155", //"http://54.241.67.36:9155", // "http://8.219.188.70:9155", //"https://porter-ibex.nucypher.community"; //nucypher porter service url
    CONTRACT_INFO: contractList[0],
    TOKEN_SYMBOL: "TBNB",
