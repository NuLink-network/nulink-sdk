...
export type DataInfo = {
  ...
  chunked?: number; //0. Indicates non-chunk upload, 1. Indicates chunk upload // This field can also be omitted; the default is non-chunk upload
};

export type ChunkStartMetaInfo = {
  label: string; //data label (name or unique string, e.g. uuid)
  md5: string; //md5 of data content
  chunkSizeInByte: number; //chunk size in Byte
  chunkCount: number; //the total number of file chunks
