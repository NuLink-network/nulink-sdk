 ...
 * @internal
 */
export const signUpdateServerDataMessage = async (privateKey: string, data: any /* "dataDict" */) => {
  
  if (data instanceof FormData) {
    throw new Error("signUpdateServerDataMessage not support type: form-data lib's FormData")
  }
