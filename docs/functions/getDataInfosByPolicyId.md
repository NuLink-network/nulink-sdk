[NuLink SDK - v0.5.17](../README.md) / [Modules](../modules.md) / getDataInfosByPolicyId
...
[core/pre/api/workflow.ts:2653](https://github.com/NuLink-network/nulink-sdk/blob/675c732/src/core/pre/api/workflow.ts#L2653)
