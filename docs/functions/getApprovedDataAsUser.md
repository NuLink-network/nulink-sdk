[NuLink SDK - v0.5.22](../README.md) / [Modules](../modules.md) / getApprovedDataAsUser
...
[core/pre/api/workflow.ts:1060](https://github.com/NuLink-network/nulink-sdk/blob/d9e8f81/src/core/pre/api/workflow.ts#L1060)
