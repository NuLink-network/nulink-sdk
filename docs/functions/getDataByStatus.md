[NuLink SDK - v0.5.27](../README.md) / [Modules](../modules.md) / getDataByStatus
...
[core/pre/api/workflow.ts:1179](https://github.com/NuLink-network/nulink-sdk/blob/caaf0a6/src/core/pre/api/workflow.ts#L1179)
