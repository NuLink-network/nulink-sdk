[NuLink SDK - v0.5.7](../README.md) / [Modules](../modules.md) / approvalApplicationForUseDatas
...
[core/pre/api/workflow.ts:2006](https://github.com/NuLink-network/nulink-sdk/blob/65ffe0d/src/core/pre/api/workflow.ts#L2006)
