[NuLink SDK - v0.5.6](../README.md) / [Modules](../modules.md) / approvalApplicationForUseDatas
...
[core/pre/api/workflow.ts:1993](https://github.com/NuLink-network/nulink-sdk/blob/9e77a59/src/core/pre/api/workflow.ts#L1993)
