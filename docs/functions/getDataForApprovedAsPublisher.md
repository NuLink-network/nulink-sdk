[NuLink SDK - v0.5.20](../README.md) / [Modules](../modules.md) / getDataForApprovedAsPublisher

# Function: getDataForApprovedAsPublisher

▸ **getDataForApprovedAsPublisher**(`data`): `Promise`<`object`\>
...
[api/pre.ts:588](https://github.com/NuLink-network/nulink-sdk/blob/e6138bf/src/api/pre.ts#L588)
