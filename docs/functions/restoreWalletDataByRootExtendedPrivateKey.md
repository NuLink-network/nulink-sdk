[NuLink SDK - v0.5.7](../README.md) / [Modules](../modules.md) / restoreWalletDataByRootExtendedPrivateKey
...
[api/wallet.ts:75](https://github.com/NuLink-network/nulink-sdk/blob/65ffe0d/src/api/wallet.ts#L75)
