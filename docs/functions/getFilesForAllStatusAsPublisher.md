[NuLink SDK - v0.0.6](../README.md) / [Modules](../modules.md) / getFilesForAllStatusAsPublisher

# Function: getFilesForAllStatusAsPublisher

▸ **getFilesForAllStatusAsPublisher**(`data`): `Promise`<`object`\>
...
[api/pre.ts:427](https://github.com/NuLink-network/nulink-sdk/blob/541ac45/src/api/pre.ts#L427)
