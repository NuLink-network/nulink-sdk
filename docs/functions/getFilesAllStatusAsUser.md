[NuLink SDK - v0.0.6](../README.md) / [Modules](../modules.md) / getFilesAllStatusAsUser

# Function: getFilesAllStatusAsUser

▸ **getFilesAllStatusAsUser**(`account`, `pageIndex?`, `pageSize?`): `Promise`<`object`\>
