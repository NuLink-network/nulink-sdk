[NuLink SDK - v0.5.6](../README.md) / [Modules](../modules.md) / getPolicysTokenCost
...
[core/pre/api/workflow.ts:1333](https://github.com/NuLink-network/nulink-sdk/blob/9e77a59/src/core/pre/api/workflow.ts#L1333)
