[NuLink SDK - v0.0.9](../README.md) / [Modules](../modules.md) / getPolicysTokenCost
...
[core/pre/api/workflow.ts:1421](https://github.com/NuLink-network/nulink-sdk/blob/66c291e/src/core/pre/api/workflow.ts#L1421)
