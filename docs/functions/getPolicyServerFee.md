[NuLink SDK - v0.5.7](../README.md) / [Modules](../modules.md) / getPolicyServerFee
...
[api/pre.ts:34](https://github.com/NuLink-network/nulink-sdk/blob/65ffe0d/src/api/pre.ts#L34)
