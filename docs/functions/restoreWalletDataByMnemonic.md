[NuLink SDK - v0.5.6](../README.md) / [Modules](../modules.md) / restoreWalletDataByMnemonic
...
[api/wallet.ts:96](https://github.com/NuLink-network/nulink-sdk/blob/9e77a59/src/api/wallet.ts#L96)
