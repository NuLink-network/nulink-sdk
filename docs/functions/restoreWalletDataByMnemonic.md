[NuLink SDK - v0.5.17](../README.md) / [Modules](../modules.md) / restoreWalletDataByMnemonic
...
[api/wallet.ts:98](https://github.com/NuLink-network/nulink-sdk/blob/675c732/src/api/wallet.ts#L98)
