[NuLink SDK - v0.5.22](../README.md) / [Modules](../modules.md) / restoreWalletDataByMnemonic
...
[api/wallet.ts:98](https://github.com/NuLink-network/nulink-sdk/blob/d9e8f81/src/api/wallet.ts#L98)
