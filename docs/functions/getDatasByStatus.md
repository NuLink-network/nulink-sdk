[NuLink SDK - v0.5.7](../README.md) / [Modules](../modules.md) / getDatasByStatus
...
[core/pre/api/workflow.ts:1103](https://github.com/NuLink-network/nulink-sdk/blob/65ffe0d/src/core/pre/api/workflow.ts#L1103)
