[NuLink SDK - v0.5.7](../README.md) / [Modules](../modules.md) / getPolicysServerFee
...
[api/pre.ts:68](https://github.com/NuLink-network/nulink-sdk/blob/65ffe0d/src/api/pre.ts#L68)
