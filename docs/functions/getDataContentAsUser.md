[NuLink SDK - v0.5.22](../README.md) / [Modules](../modules.md) / getDataContentAsUser
...
[core/pre/api/workflow.ts:2826](https://github.com/NuLink-network/nulink-sdk/blob/d9e8f81/src/core/pre/api/workflow.ts#L2826)
