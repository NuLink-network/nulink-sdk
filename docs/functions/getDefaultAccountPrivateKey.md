[NuLink SDK - v0.5.22](../README.md) / [Modules](../modules.md) / getDefaultAccountPrivateKey
...
[api/wallet.ts:302](https://github.com/NuLink-network/nulink-sdk/blob/d9e8f81/src/api/wallet.ts#L302)
