[NuLink SDK - v0.5.7](../README.md) / [Modules](../modules.md) / getPolicyTokenCost
...
[core/pre/api/workflow.ts:1308](https://github.com/NuLink-network/nulink-sdk/blob/11cbdd7/src/core/pre/api/workflow.ts#L1308)
