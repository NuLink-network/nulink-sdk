[NuLink SDK - v0.0.9](../README.md) / [Modules](../modules.md) / approvalApplicationForUseData
...
[core/pre/api/workflow.ts:2231](https://github.com/NuLink-network/nulink-sdk/blob/66c291e/src/core/pre/api/workflow.ts#L2231)
