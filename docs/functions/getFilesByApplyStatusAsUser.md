[NuLink SDK - v0.0.6](../README.md) / [Modules](../modules.md) / getFilesByApplyStatusAsUser

# Function: getFilesByApplyStatusAsUser

▸ **getFilesByApplyStatusAsUser**(`account`, `status?`, `pageIndex?`, `pageSize?`): `Promise`<`object`\>
