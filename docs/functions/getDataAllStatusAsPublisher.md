[NuLink SDK - v0.5.17](../README.md) / [Modules](../modules.md) / getDataAllStatusAsPublisher

# Function: getDataAllStatusAsPublisher

▸ **getDataAllStatusAsPublisher**(`account`, `pageIndex?`, `pageSize?`): `Promise`<`object`\>
...
[core/pre/api/workflow.ts:804](https://github.com/NuLink-network/nulink-sdk/blob/675c732/src/core/pre/api/workflow.ts#L804)
