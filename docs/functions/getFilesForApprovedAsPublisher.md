[NuLink SDK - v0.0.6](../README.md) / [Modules](../modules.md) / getFilesForApprovedAsPublisher

# Function: getFilesForApprovedAsPublisher

▸ **getFilesForApprovedAsPublisher**(`data`): `Promise`<`object`\>
...
[api/pre.ts:339](https://github.com/NuLink-network/nulink-sdk/blob/541ac45/src/api/pre.ts#L339)
