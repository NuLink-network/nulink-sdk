[NuLink SDK - v0.5.31](../README.md) / [Modules](../modules.md) / getDataByStatusForAllApplyAsPublisher

# Function: getDataByStatusForAllApplyAsPublisher

▸ **getDataByStatusForAllApplyAsPublisher**(`data`): `Promise`<`object`\>
...
[api/pre.ts:766](https://github.com/NuLink-network/nulink-sdk/blob/b71aeb1/src/api/pre.ts#L766)
