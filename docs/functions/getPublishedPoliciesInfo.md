[NuLink SDK - v0.5.22](../README.md) / [Modules](../modules.md) / getPublishedPoliciesInfo
...
[core/pre/api/workflow.ts:1230](https://github.com/NuLink-network/nulink-sdk/blob/d9e8f81/src/core/pre/api/workflow.ts#L1230)
